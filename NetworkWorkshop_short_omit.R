...
## How would you plot the network above? Use the code from the previous example to help you
...
# How would we use the object CeramicX01 created above to make a network object? What kind of threshold do we want to use?
...
# What happens if we change the value of k. Edit the code above and try k=3
...
# How would you use the function above to calculate stats for the X^2 networks?
